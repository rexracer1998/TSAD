...
<body>
    <div id="page-containercus">
        ...
        <div class="d-flex justify-content-center">
            <h1 class="impact">TSAD</h1>
        </div>
        <br>


<form action="/search/index.php" method="get">
        <div class="sizemiddle input-group flex-nowrap" id="searchbar">
            <input type="text" class="form-control rounded-pill typeahead" placeholder="Que recherchez vous ?" aria-label="Username" aria-describedby="addon-wrapping" name="search">
            <input type="submit" value="" style="visibility: hidden">
        </div>
        <br></br>
        <div class="card-place d-flex justify-content-center">
            <div class="card card-hover" style="width: 18rem;">
                <h3 class="card-title text-center">AURA</h5>
                <img src="img/placeholder.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text">#Hashtags #Exemple #UwU</p>
                    <p class="card-text">Créateur: Max1116</p>
                    <p class="card-text">Provider: Max1116</p>
                </div>
            </div>
